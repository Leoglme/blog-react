...
function Main(props) {
    ...
    const fetchRandomPosts = useCallback(() => {
        axios({
            ...
            url: `http://localhost:4242/blog/posts/` + user.username
        }).then(res => {
            const posts = [];
            ...
            articles.forEach((article) => {
                ...
                const post = {
                    ...
                    timestamp: parseInt(article.article__date),
                    name: article.article__title,
                };
                posts.push(post);
            })
    ...
    const selectUpdateArticle = useCallback(() => {
        smoothScrollTop();
        document.title = "Blog | Editing Article";
        setSelectedTab("UpdateArticle");
    }, [
        setSelectedTab
    ]);
    ...
    const selectPosts = useCallback(() => {
        smoothScrollTop();
        document.title = "Blog | Votre blog";
        ...
        <Fragment>
            ...
            <main className={classNames(classes.main)}>
                <Routing
                    ...
                    selectUpdateArticle={selectUpdateArticle}
