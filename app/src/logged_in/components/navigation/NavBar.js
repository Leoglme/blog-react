...
function NavBar(props) {
  ...
  const { selectedTab, messages, classes, width, openAddBalanceDialog ,handleMobileDrawerClose} = props;
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: {
        desktop: (
            <HomeRoundedIcon className="text-white" fontSize="small" />
        ),
        mobile: <HomeRoundedIcon className="text-white" />,
      },
    },
  ];
  return (
